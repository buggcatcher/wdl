document.addEventListener("DOMContentLoaded", () => {
  ...
  if (galleryContainer) {
    ...
    const basePath = "../../assets/img/boxes/street-food/lacarraia/"; //path pic
      ...
      <div class="gallery">
        ...
        <div class="gallery-track-container">
          <div class="gallery-track">
            ${images.map(src => `<div class="gallery-slide"><img src="${src}" alt="La Carraia" /></div>`).join('')}
          </div>
        </div>
