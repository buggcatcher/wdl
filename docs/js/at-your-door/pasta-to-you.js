document.addEventListener("DOMContentLoaded", () => {
  ...
  if (galleryContainer) {
    ...
    const basePath = "../../assets/img/boxes/at-your-door/pasta-to-you/"; //path pic
      ...
      <div class="gallery">
        ...
        <div class="gallery-track-container">
          <div class="gallery-track">
            ${images.map(src => `<div class="gallery-slide"><img src="${src}" alt="Pasta Lesson Experience" /></div>`).join('')}
          </div>
        </div>
