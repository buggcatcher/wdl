document.addEventListener("DOMContentLoaded", () => {
  ...
  if (galleryContainer) {
    const imageFiles = ["01.jpeg","02.jpeg","03.jpeg","04.jpg"]; //file name of pic
    const basePath = "../../assets/img/boxes/at-your-door/beauty-farm/"; //path pic
      ...
      <div class="gallery">
        ...
        <div class="gallery-track-container">
          <div class="gallery-track">
            ${images.map(src => `<div class="gallery-slide"><img src="${src}" alt="Beauty Farm" /></div>`).join('')}
          </div>
        </div>
